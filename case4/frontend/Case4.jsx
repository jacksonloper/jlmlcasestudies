...
export default function Case4() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${import.meta.env.BASE_URL}case4/data/test_y.npy`);
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <section className="mb-12">
          ...
          <div className="prose max-w-none text-gray-700 space-y-4">
            <p>
              Learn to perform <strong>modular division mod 97</strong>. Given two numbers{' '}
              <InlineMath math="a \in \{0, 1, \ldots, 96\}" /> and{' '}
              <InlineMath math="b \in \{1, 2, \ldots, 96\}" /> (b ≠ 0), predict{' '}
              <InlineMath math="(a / b) \mod 97" />.
            </p>

            <p>
              Since 97 is prime, every non-zero element has a multiplicative inverse.
              Division is computed as: <InlineMath math="(a / b) \equiv a \cdot b^{-1} \pmod{97}" />,
              where <InlineMath math="b^{-1}" /> is the modular multiplicative inverse of <InlineMath math="b" />.
            </p>
            ...
            <p>
              ...
              <InlineMath math="97 \times 96 = 9312" /> valid pairs (excluding b=0), split randomly.
            </p>
        ...
        <section className="mb-12">
          ...
          <div className="space-y-3">
            <a
              href={`${import.meta.env.BASE_URL}case4/data/train_x.npy`}
            ...
            <a
              href={`${import.meta.env.BASE_URL}case4/data/train_y.npy`}
            ...
            <p className="text-sm text-gray-600">
              Training X: ~4657 × 194 one-hot encoded inputs (float32)
              <br />
              Training Y: ~4657 labels in &#123;0, ..., 96&#125; (int32)
            </p>
          </div>

          <div className="space-y-3 mt-6">
            <a
              href={`${import.meta.env.BASE_URL}case4/data/test_x.npy`}
              download="test_x.npy"
              className="inline-block bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors"
            >
              Download Test X
            ...
            <p className="text-sm text-gray-600">
              Test X: ~4656 × 194 one-hot encoded inputs (float32)
            </p>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            <p className="text-gray-700 mb-4">
              ...
              <strong>1D array of ~4656 integers</strong> (one prediction per test point,
        ...
        <section className="mb-12 border-t pt-8">
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <p className="text-gray-700 mb-4">
              View the solutions page to learn more about the modular division task
